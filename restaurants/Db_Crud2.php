...
class Db_crud 
{
        ...
        public function __construct()
        {
            ...
            //$this->CI->load(MY_Form_validation);
	...
	public function chain($menu_name)
	{
                ...
                $crud->set_rules('name','Name','trim|required|alpha_space|required|min_length[1]|max_length[100]');
                ...
                $crud->set_rules('turnover', 'Turnover','trim|decimal|required|min_length[1]|max_length[30]');
                $crud->set_rules('picture', 'Picture', 'required');
                $crud->set_rules('phone', 'Phone', 'trim|numeric|required');
                $crud->set_rules('fax', 'Fax', 'trim|numeric');
        ...
        public function orders($menu_name)
	{
        ...
        public function devices($menu_name)
        {
        ...
        public function role($menu_name)
	{
            ...
            $crud->set_rules('name', 'Locale', 'trim|alpha_numeric_space|required|min_length[1]|max_length[20]|is_unique[languages.locale]');
        ...
        public function user($menu_name,$chain_id,$outlet_id)
	{
            ...
            $crud->required_fields('chainid', 'outletid', 'roleid', 'fname', 'lname', 'nname', 'dob', 'doj', 'shift', 'username', 'password');
            ...
            $crud->set_rules('nname', 'Nick Name', 'trim|alpha_space|required|min_length[1]|max_length[10]');
            $crud->set_rules('username', 'User ID', 'trim|alpha_space|required|min_length[7]|max_length[15]');
            $crud->set_rules('password', 'Password', 'trim|alpha_space|required|min_length[6]|max_length[10]');
        ...
        public function outlet($menu_name,$chain_id,$outlet_id)
	{
            ...
            $crud->required_fields('chainid', 'name','country', 'city', 'state',  'logo', 'picture',  'phone');
            
            
            
            $crud->add_fields('chainid', 'name', 'address',  'country', 'state','city', 'zipcode', 'logo', 'picture', 'video', 'phone', 'fax', 'email', 'speciality', 'eodprocessing', 'currency', 'multilanguagesupport', 'status');
            $crud->edit_fields('chainid', 'name', 'address', 'country', 'state','city', 'zipcode', 'logo', 'picture', 'video', 'phone', 'fax', 'email', 'speciality', 'eodprocessing', 'currency', 'multilanguagesupport', 'status');
            ...
            $crud->set_rules('email', 'Email', 'trim|valid_email|required');
            $crud->set_rules('status', 'Status', 'required');
            $crud->set_rules('phone', 'Phone', 'trim|numeric|required|min_length[9]|max_length[15]|');
        ...
        public function languages($menu_name)
        {
            ...
            $crud->set_rules('language', 'Language', 'trim|alpha|required|min_length[2]|max_length[2]|is_unique[languages.language]');
        ...
        public function tables($menu_name,$chain_id,$outlet_id)
	{
        ...
        public function item($menu_name,$chain_id,$outlet_id)
        {
            ...
            $crud->columns('name','recipe', 'url', 'video','video_thumnail',  'spicelevel', 'price');
            //$crud->unset_fields()
            ...
            $crud->required_fields('chainid', 'outletid', 'name',  'recipe', 'url', 'video','spicelevel', 'price');
            ...
            $crud->set_rules('price', 'Price', 'trim|decimal|required');
        ...
        function thumbnail_callback_after_upload($uploader_response,$field_info, $files_to_upload)
        {
            ...
            if($fileType == 'mp4')
            {
                ...
                shell_exec('/usr/local/bin/ffmpeg -i assets/uploads/files/'.$fullfilename.' -vframes 1 -s 320x240 -ss 10 assets/uploads/files/thumb-'.$filename.'.jpg');
       ...
       function get_thumbnail_callback($post_array)
       {
        ...
        public function category($menu_name,$chain_id,$outlet_id)
        {
            ...
            $crud->columns('name', 'sdescription',  'parentid', 'url', 'burl', 'video');
            $crud->display_as('outletid','Outlet');
