<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['grocery_crud_file_upload_allow_file_types'] 		= 'gif|jpeg|jpg|png|mp4';
	$config['grocery_crud_file_upload_max_file_size'] 			= '2000MB'; //ex. '10MB' (Mega Bytes), '1067KB' (Kilo Bytes), '5000B' (Bytes)
    ...
    $config['grocery_crud_default_theme'] = 'datatables';// changed from flexigrid to datatables
