<table cellpadding="0" cellspacing="0" border="0" class="display groceryCrudTable table table-striped table-hover table-bordered dataTable" id="<?php echo uniqid(); ?>">
	<thead>
		<tr>
	...
	<tbody>
		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<td class='actions' >
				...
				?>
				<?php if(!$unset_read){?>
                            <a href="<?php echo $row->read_url?>" title="Read" class="btn btn-xs btn-success" role="button">
...
<!--						<span class="ui-button-text">&nbsp;<?php /*echo $this->l('list_view');*/ ?></span>-->
				...
				<?php if(!$unset_edit){?>
					<a href="<?php echo $row->edit_url?>"  title="Edit"  class="btn  btn-xs btn-info edit_button" role="button">
...
<!--						<span class="ui-button-text">&nbsp;<?php /* echo $this->l('list_edit');*/ ?></span>-->
				...
				<?php if(!$unset_delete){?>
					<a onclick = "javascript: return delete_row('<?php echo $row->delete_url?>', '<?php echo $num_row?>')"
						href="javascript:void(0)" class="btn  btn-xs btn-danger delete"  title="Delete"  role="button">
