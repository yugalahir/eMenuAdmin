<table cellpadding="0" cellspacing="0" border="0" class="display groceryCrudTable dataTables_scroll table table-striped table-hover table-bordered dataTable" id="<?php echo uniqid(); ?>">
	<thead>
		<tr>
