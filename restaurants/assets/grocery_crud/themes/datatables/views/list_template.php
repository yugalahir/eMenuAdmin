<?php
	...
	$this->set_css($this->default_theme_path.'/datatables/media/css/jquery.dataTables.css');//Gennext Custom Changes
	$this->set_css($this->default_theme_path.'/datatables/extensions/TableTools/css/dataTables.tableTools.css');//Gennext Custom Changes
        $this->set_css($this->default_theme_path.'/datatables/extensions/TableTools/css/dataTables.tableTools.min.css');//Gennext Custom Changes
	...
	$this->set_js_lib($this->default_theme_path.'/datatables/media/js/jquery.dataTables.js');//Gennext Custom Changes
        $this->set_js_lib($this->default_theme_path.'/datatables/media/js/jquery.dataTables.rowReordering.js');//Gennext Custom Changes
	...
	$this->set_js($this->default_theme_path.'/datatables/extensions/TableTools/js/dataTables.tableTools.js');//Gennext Custom Changes
        $this->set_js($this->default_theme_path.'/datatables/extensions/TableTools/js/dataTables.tableTools.min.js');//Gennext Custom Changes
	...
	<?php if(!$unset_add){?>
		...
		<a role="button" class="add_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" href="<?php echo $add_url?>">
			<button type="button" class="btn btn-primary" name="add">
                                       <?php echo $this->l('list_add'); ?> <?php echo $subject?> <i class="fa fa-plus"></i>
                                    </button>
